...
## [AnyBURL-22](https://web.informatik.uni-mannheim.de/AnyBURL/) ##
IndKGC requires anyburl rules and predictions over train, valid, and test_ind for each dataset used.  
